...
describe("/properties", () => {
  ...
  it("POST /properties -  Must be able to create a property", async () => {
  ...
  it("POST /properties -  should not be able to create property that already exists", async () => {
    const categories = await request(app).get("/categories");
    const adminLoginResponse = await request(app)
      .post("/login")
      .send(mockedAdminLogin);
  ...
  it("POST /properties -  should not be able to create property not being admin", async () => {
    const categories = await request(app).get("/categories");
  ...
  it("POST /properties -  should not be able to create property without authentication", async () => {
    const categories = await request(app).get("/categories");
    mockedProperty.categoryId = categories.body[0].id;
    const response = await request(app)
      .post("/properties")
  ...
  it("POST /properties -  should not be able to create property with invalid categoryId", async () => {
    const adminLoginResponse = await request(app)
      .post("/login")
      .send(mockedAdminLogin);
    const response = await request(app)
  ...
  it("POST /properties -  must not be able to create a property with invalid zipCode", async () => {
    const categories = await request(app).get("/categories");
    const adminLoginResponse = await request(app)
      .post("/login")
      .send(mockedAdminLogin);
  ...
  it("POST /properties -  must not be able to create a property with invalid state", async () => {
    const categories = await request(app).get("/categories");
    const adminLoginResponse = await request(app)
      .post("/login")
      .send(mockedAdminLogin);
  ...
  it("GET /properties -  Must be able to list all properties", async () => {
